...
const DeliveredInput = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (sd && ed && sd > ed) {
      nextErrors['tanggal-dikirim'] = 'Tanggal awal tidak boleh lebih besar dari tanggal akhir';
      nextErrors['tanggal-terima'] = 'Tanggal akhir tidak boleh lebih kecil dari tanggal awal';
    }
